...
const colorsAco = ['#0019ff', '#6BFF4F', '#FF4301'];
const randomTextColorIndexAco = Math.floor(Math.random() * colorsAco.length);
const randomTextColorAco = colorsAco[randomTextColorIndexAco];

// Set CSS variable for hover color
document.documentElement.style.setProperty('--random-hover-color-aco', randomTextColorAco);
